...
exports.signUpUser = async (req,res,next) => {
    ...
    try {
        ...
        const vUser = await User.create(user);
        
        
        const token = vUser.getDataValue("id");
        const email = vUser.getDataValue("email");
        const name = vUser.getDataValue("name");
...
exports.signInUser = async (req,res,next) => {
    ...
    try {
        ...
        if(authType === 'EMP'){
            ...
            const hashedPassword = vUser.getDataValue("password");
